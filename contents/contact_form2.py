...
class ContactForm2:
    ...
    def emergency_info(self):
        ...
        self.other_name_label = tk.Label(self.emergency_frame, text="\tName:", font=("Arial", 10))
        self.other_name_label.grid(row=1, column=0, sticky="w")
        self.other_name_entry = ttk.Entry(self.emergency_frame, justify="center")
        self.other_name_entry.grid(row=1, column=1)

        # Phone number/email label and entry
        self.phone_email_label = tk.Label(self.emergency_frame, text="\tPhone Number/Email:", font=("Arial", 10))
        self.phone_email_label.grid(row=2, column=0, sticky="w")
        self.phone_email_entry = ttk.Entry(self.emergency_frame, justify="center")
        self.phone_email_entry.grid(row=2, column=1)

        # Address label and entry
        self.other_address_label = tk.Label(self.emergency_frame, text="\tAddress:", font=("Arial", 10))
        self.other_address_label.grid(row=3, column=0, sticky="w")
        self.other_address_entry = ttk.Entry(self.emergency_frame, width=50, justify="center")
        self.other_address_entry.grid(row=3, column=1, columnspan=4, padx=38)

        # Relationship label and entry
        self.relationship_label = tk.Label(self.emergency_frame, text="\tRelationship:", font=("Arial", 10))
    ...
    def get_entries2(self):
        ...
        entries2 = {
            "Emergency Name": self.other_name_entry.get(),
            "Emergency Phone/Email": self.phone_email_entry.get(),
